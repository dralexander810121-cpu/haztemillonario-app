...
const RECOMPENSAS = [
  ...
  { accion: 'Seguir Facebook',   dias: '+1 día', emoji: '📘', desc: 'Números ganadores diarios' },
  { accion: 'Seguir Instagram',  dias: '+1 día', emoji: '📸', desc: 'Contenido exclusivo' },
  { accion: 'Seguir TikTok',     dias: '+1 día', emoji: '🎵', desc: 'Videos de charada' },
  { accion: 'Seguir YouTube',    dias: '+1 día', emoji: '▶️', desc: 'Análisis y tutoriales' },
  { accion: 'Invitar un amigo',  dias: '+1 día', emoji: '🤝', desc: 'Tu amigo se registra' },
];
    ...
    <div className="fade-in">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            {tiempo && (
              <div className="card px-6 py-4 bg-gold/10 border-gold/40 text-center">
                <div className="text-cream/60 text-xs mb-1">⏱️ Tiempo gratis restante</div>
            ...
            {!tiempo && !esPremium && (
              <div className="card px-6 py-4 bg-wine/20 border-wine/40 text-center">
                <div className="text-cream/60 text-xs mb-2">Tu hora gratis terminó</div>
      ...
      {!esPremium && (
        <section className="max-w-6xl mx-auto px-4 md:px-8 py-10">
          <div className="card p-6 bg-gradient-to-r from-gold/10 to-wine/10 border-gold/30">
            <h2 className="font-display text-2xl text-gold-light font-bold mb-1">🎁 Gana 7 días Premium gratis</h2>
            <p className="text-cream/60 text-sm mb-5">Cada acción te da 1 día. Completa las 7 y tienes una semana entera.</p>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { titulo: 'Soñar',       desc: 'Interpreta tus sueños',       emoji: '🌙', href: '/sonar' },
            { titulo: 'Generador',   desc: 'Crea combinaciones ganadoras',emoji: '🎲', href: '/generador' },
            { titulo: 'Análisis',    desc: 'Estadísticas históricas',      emoji: '📊', href: '/analisis' },
            ...
            { titulo: 'Mi cuenta',   desc: 'Perfil y suscripción',         emoji: '👤', href: '/cuenta' },
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-cream/60 mt-2">Números ganadores y charada todos los días</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {REDES.map((r) => (
      ...
      {!esPremium && (
        <section className="max-w-4xl mx-auto px-4 md:px-8 py-16">
          <div className="card p-10 bg-gradient-to-br from-gold/10 to-wine/10 border-gold/30 glow text-center">
            ...
            <p className="text-cream/70 mt-3 leading-relaxed max-w-xl mx-auto">Sin anuncios · Acceso total ilimitado · Análisis completo · Contenido exclusivo del Dr. Figueredo</p>
